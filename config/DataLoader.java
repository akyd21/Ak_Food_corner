...
public class DataLoader {
    ...
    CommandLineRunner initDatabase(ProductRepository productRepository, AdminRepository adminRepository) {
        return args -> {
            ...
            Admin defaultAdmin = adminRepository.findByAdminEmail("akadmin@gmail.com");
            if (defaultAdmin == null) {
                defaultAdmin = new Admin();
                defaultAdmin.setAdminName("AK Admin");
                defaultAdmin.setAdminEmail("akadmin@gmail.com");
                defaultAdmin.setAdminPassword("admin1234");
                defaultAdmin.setAdminNumber("9876543210");
                adminRepository.save(defaultAdmin);
                System.out.println("Default Admin created: akadmin@gmail.com / admin1234");
            }
        };
    }
}
